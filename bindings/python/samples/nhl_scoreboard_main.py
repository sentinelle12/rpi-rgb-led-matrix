        ...
        while True:
            ...
            if self.is_there_a_game_tonight:
                ...
                if self.game_info["abstract_game_state"] == "Live" or self.game_info["abstract_game_state"] == "Final":
                    ...
                    graphics.DrawText(offscreen_canvas, font3, 20, 20, white,
                                      self.game_live_data['current_time_remaining'])
                    ...
                    graphics.DrawText(offscreen_canvas, font4, 10, 56, red,
                                      str(self.game_live_data['home_shots_on_goal']))
                    graphics.DrawText(offscreen_canvas, font4, 54, 56, red,
                                      str(self.game_live_data['away_shots_on_goal']))
